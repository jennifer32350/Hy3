...
[Hy3 Data Analyst MCP](mcp_servers/hy3_data_analyst/README.md) 是一个可安装的本地 stdio
MCP Server，可安全分析 CSV、JSON 和 JSONL 数据。它为 CodeBuddy、WorkBuddy、Cursor 等
MCP 客户端提供数据检查、Hy3 辅助分析、基于证据的图表建议和本地 PNG 渲染能力。
